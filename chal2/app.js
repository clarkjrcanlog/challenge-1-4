...
let cityCollect = [];
for(i = 0; i< Users.length; i++){
  cityCollect.push(Users[i].address.city);
}

// let counter =  [];
// for(j = 0; j < cityCollect.length; j++){
//     if(counter.hasOwnProperty(cityCollect[j])){
//       counter[j]++;
//     }else{
//       counter[cityCollect[j]] = 1;
//     }
//     console.log(`${cityCollect[j]}: ${counter[j]}`)
// }
